...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "depot.form.unit": "Unit",
    "depot.form.save": "Save",
    "depot.export": "Export Excel",
    ...
    "depot.totals.monthlyProfit": "Monthly profit",
    ...
    "depot.toast.noNegativeStock": "Stock cannot go below zero",
    ...
    "sales.toast.invalidPrice": "Enter a valid price",
    "sales.noMatches": "No cart items match your search.",
    "sales.searchMode": "Search mode",
    "sales.searchMode.item": "Item",
    "sales.searchMode.category": "Category",
    "sales.searchByCategory": "Browse by category to narrow the list.",
    "sales.itemsCount": "{count} items",
    "sales.filteredByQuery": "Filtered by search",
    "sales.filteredCategory": "Showing category: {category}",
    ...
    "customers.export.all": "Export all (Excel)",
    "customers.export.single": "Export report (Excel)",
    ...
    "shopping.monthly.helper": "Products with stock at 1 or below appear here automatically for restock.",
    ...
    "shopping.toast.inventoryRestored": "Inventory restored for {count} products",
    "shopping.toast.inventoryRestoreUnavailable": "No inventory backup is available for this list.",
    "shopping.toast.inventoryRestoreInsufficient": "Not enough stock to restore {count} products.",
    "shopping.toast.inventoryRestoreMissing": "Some products are missing and cannot be restored ({count}).",
    ...
    "shopping.confirm.restoreInventory": "Restore inventory from the last transfer for \"{title}\"? This will subtract the transferred quantities from the depot and reopen the list.",
    ...
    "shopping.detail.toast.itemQuantityRequired": "Enter a valid quantity",
    ...
    "shopping.detail.export.columns.itemCategory": "Category",
    "shopping.detail.export.columns.itemQuantity": "Quantity",
    "shopping.detail.export.columns.itemBuyPrice": "Buy price",
    "shopping.detail.export.columns.itemSellPrice": "Sell price",
    ...
    "history.export.all": "Export all (Excel)",
    "history.export.summary": "Export summary (Excel)",
    ...
    "history.actions.edit": "Edit sale",
    "history.actions.delete": "Delete sale",
    "history.confirm.delete": "Delete transaction #{id}? Stock will be restored.",
    "history.edit.title": "Edit transaction #{id}",
    "history.edit.addProduct": "Add product",
    "history.edit.searchProducts": "Search products to add...",
    "history.edit.noProducts": "No products available to add.",
    "history.edit.save": "Save changes",
    "history.edit.available": "Available",
    "history.toast.deleted": "Transaction deleted and stock restored",
    "history.toast.deleteError": "Failed to delete transaction",
    "history.toast.updated": "Transaction updated successfully",
    "history.toast.updateError": "Failed to update transaction",
    "history.toast.updateStockError": "Not enough stock for {name}",
    "history.toast.editMissingProduct": "This transaction contains a product that is no longer in the depot.",
    "history.toast.emptyEdit": "Add at least one item before saving.",
    ...
    "settings.export.title": "Excel Export",
    "settings.export.description": "Choose where Excel files are saved on your phone.",
    "settings.export.destination.label": "Export destination",
    "settings.export.destination.placeholder": "Select destination",
    "settings.export.destination.downloads": "Save to Downloads",
    "settings.export.destination.share": "Choose location (Share)",
    "settings.export.destination.both": "Save to Downloads and Share",
  ...
  tr: {
    ...
    "depot.form.unit": "Birim",
    "depot.form.save": "Kaydet",
    "depot.export": "Excel dışa aktar",
    ...
    "depot.totals.monthlyProfit": "Aylık kâr",
    "depot.stock": "stokta",
    ...
    "depot.toast.noNegativeStock": "Stok sıfırın altına düşemez",
    ...
    "sales.toast.invalidPrice": "Geçerli bir fiyat girin",
    "sales.noMatches": "Sepette aramanıza uyan ürün yok.",
    "sales.searchMode": "Arama türü",
    "sales.searchMode.item": "Ürün",
    "sales.searchMode.category": "Kategori",
    "sales.searchByCategory": "Listeyi daraltmak için kategoriye göre göz atın.",
    "sales.itemsCount": "{count} Ürün",
    "sales.filteredByQuery": "Aramayla filtrelendi",
    "sales.filteredCategory": "Gosterilen kategori: {category}",
    ...
    "customers.export.all": "Tümünü Excel dışa aktar",
    "customers.export.single": "Raporu Excel dışa aktar",
    "customers.export.overviewFilename": "customers_overview",
    ...
    "shopping.monthly.helper": "Stok miktarı 1 veya daha az olan ürünler otomatik olarak burada görünür.",
    ...
    "shopping.actions.restoreInventory": "Envanteri geri yükle",
    "shopping.actions.delete": "Sil",
    "shopping.actions.deleteList": "Listeyi sil",
    "shopping.actions.export": "Excel dışa aktar",
    ...
    "shopping.toast.inventoryRestored": "{count} ürün için envanter geri yüklendi",
    "shopping.toast.inventoryRestoreUnavailable": "Bu liste için envanter yedeği bulunamadı.",
    "shopping.toast.inventoryRestoreInsufficient": "{count} ürün için yeterli stok yok.",
    "shopping.toast.inventoryRestoreMissing": "Bazı ürünler eksik ve geri yüklenemiyor ({count}).",
    ...
    "shopping.confirm.restoreInventory": "\"{title}\" için son aktarım geri alınsın mı? Bu işlem depodaki miktarları düşürür ve listeyi yeniden açar.",
    ...
    "shopping.detail.toast.itemQuantityRequired": "Geçerli bir miktar girin",
    ...
    "shopping.detail.export.columns.itemCategory": "Kategori",
    "shopping.detail.export.columns.itemQuantity": "Miktar",
    "shopping.detail.export.columns.itemBuyPrice": "Alış fiyatı",
    "shopping.detail.export.columns.itemSellPrice": "Satış fiyatı",
    ...
    "history.export.all": "Tümünü Excel dışa aktar",
    "history.export.summary": "Özeti Excel dışa aktar",
    ...
    "history.actions.edit": "Satışı düzenle",
    "history.actions.delete": "Satışı sil",
    "history.confirm.delete": "#{id} numaralı işlem silinsin mi? Stok geri yüklenecek.",
    "history.edit.title": "#{id} numaralı işlemi düzenle",
    "history.edit.addProduct": "Ürün ekle",
    "history.edit.searchProducts": "Eklenecek ürünleri ara...",
    "history.edit.noProducts": "Eklenecek ürün bulunamadı.",
    "history.edit.save": "Değişiklikleri kaydet",
    "history.edit.available": "Mevcut",
    "history.toast.deleted": "İşlem silindi ve stok geri yüklendi",
    "history.toast.deleteError": "İşlem silinemedi",
    "history.toast.updated": "İşlem başarıyla güncellendi",
    "history.toast.updateError": "İşlem güncellenemedi",
    "history.toast.updateStockError": "{name} için yeterli stok yok",
    "history.toast.editMissingProduct": "Bu işlemde artık depoda bulunmayan bir ürün var.",
    "history.toast.emptyEdit": "Kaydetmeden önce en az bir ürün ekleyin.",
    ...
    "settings.export.title": "Excel Dışa Aktarım",
    "settings.export.description": "Excel dosyalarının telefona nereye kaydedileceğini seçin.",
    "settings.export.destination.label": "Dışa aktarma konumu",
    "settings.export.destination.placeholder": "Konum seçin",
    "settings.export.destination.downloads": "İndirilenler'e kaydet",
    "settings.export.destination.share": "Konum seç (Paylaş)",
    "settings.export.destination.both": "İndirilenler'e kaydet ve paylaş",
  ...
  ru: {
    ...
    "depot.form.unit": "Единица",
    "depot.form.save": "Сохранить",
    "depot.export": "Экспорт Excel",
    ...
    "depot.totals.monthlyProfit": "Прибыль за месяц",
    ...
    "depot.toast.noNegativeStock": "Остаток не может быть меньше нуля",
    ...
    "sales.toast.invalidPrice": "Введите корректную цену",
    "sales.noMatches": "В корзине нет товаров по вашему запросу.",
    "sales.searchMode": "Тип Поиска",
    "sales.searchMode.item": "Товар",
    "sales.searchMode.category": "Категория",
    "sales.searchByCategory": "Посмотрите на предметы.",
    "sales.itemsCount": "{count} Товар",
    "sales.filteredByQuery": "Отфильтровано по поиску",
    "sales.filteredCategory": "Показана категория: {category}",
    "sales.clearFilters": "Сбросить",
    ...
    "customers.export.all": "Экспортировать все (Excel)",
    "customers.export.single": "Экспортировать отчёт (Excel)",
    "customers.export.overviewFilename": "customers_overview",
    ...
    "shopping.monthly.helper": "Товары с остатком 1 или меньше появляются здесь автоматически.",
    ...
    "shopping.actions.restoreInventory": "Восстановить склад",
    "shopping.actions.delete": "Удалить",
    "shopping.actions.deleteList": "Удалить список",
    "shopping.actions.export": "Экспорт Excel",
    ...
    "shopping.toast.inventoryRestored": "Склад восстановлен для товаров: {count}",
    "shopping.toast.inventoryRestoreUnavailable": "Для этого списка нет доступной резервной копии.",
    "shopping.toast.inventoryRestoreInsufficient": "Недостаточно остатка для восстановления товаров: {count}.",
    "shopping.toast.inventoryRestoreMissing": "Некоторые товары отсутствуют и не могут быть восстановлены ({count}).",
    ...
    "shopping.confirm.restoreInventory": "Восстановить склад по последнему переносу для \"{title}\"? Это уменьшит количество на складе и вновь откроет список.",
    ...
    "shopping.detail.toast.itemQuantityRequired": "Введите корректное количество",
    ...
    "shopping.detail.export.columns.itemCategory": "Категория",
    "shopping.detail.export.columns.itemQuantity": "Количество",
    "shopping.detail.export.columns.itemBuyPrice": "Закупочная цена",
    "shopping.detail.export.columns.itemSellPrice": "Цена продажи",
    ...
    "history.export.all": "Экспортировать все (Excel)",
    "history.export.summary": "Экспортировать сводку (Excel)",
    ...
    "history.actions.edit": "Изменить продажу",
    "history.actions.delete": "Удалить продажу",
    "history.confirm.delete": "Удалить сделку №{id}? Остаток будет восстановлен.",
    "history.edit.title": "Изменить сделку №{id}",
    "history.edit.addProduct": "Добавить товар",
    "history.edit.searchProducts": "Найти товар для добавления...",
    "history.edit.noProducts": "Нет товаров для добавления.",
    "history.edit.save": "Сохранить изменения",
    "history.edit.available": "Доступно",
    "history.toast.deleted": "Сделка удалена, остаток восстановлен",
    "history.toast.deleteError": "Не удалось удалить сделку",
    "history.toast.updated": "Сделка успешно обновлена",
    "history.toast.updateError": "Не удалось обновить сделку",
    "history.toast.updateStockError": "Недостаточно остатка для {name}",
    "history.toast.editMissingProduct": "В этой сделке есть товар, которого больше нет на складе.",
    "history.toast.emptyEdit": "Добавьте хотя бы одну позицию перед сохранением.",
    ...
    "settings.export.title": "Экспорт Excel",
    "settings.export.description": "Выберите, куда сохранять файлы Excel на телефоне.",
    "settings.export.destination.label": "Куда сохранять экспорт",
    "settings.export.destination.placeholder": "Выберите место",
    "settings.export.destination.downloads": "Сохранять в Загрузки",
    "settings.export.destination.share": "Выбрать место (Поделиться)",
    "settings.export.destination.both": "Сохранять в Загрузки и делиться",
